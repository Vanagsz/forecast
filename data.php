...
$windSpeed = $forecast["list"][0]["speed"];
$pressure = $forecast["list"][0]["pressure"];
$localTime = $forecast["city"]["timezone"];
$feelsLike = $forecast["list"][0]["feels_like"]["day"];
$clouds = $forecast["list"][0]["clouds"];
$humidity = $forecast["list"][0]["humidity"];
$gust = $forecast["list"][0]["gust"];
$sunrise = $forecast["list"][0]["sunrise"];
$sunset = $forecast["list"][0]["sunset"];

date_default_timezone_set("Europe/Riga");
date_default_timezone_get();

function timeConvert($timeData){
  return date("H:i", $timeData);
}
